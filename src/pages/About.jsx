              ...
              <div className="content_container">
                ...
                >
                  <li className="list-group-item" data-aos="fade-left">
                    ...
                    Ethicalcure Pharmaceuticals pioneers innovative healthcare solutions.
                  </li>
                  <li className="list-group-item" data-aos="fade-left">
          ...
          <div className="row g-5 align-items-center">
            <div className="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
              <h3 className="mb-4" data-aos="fade-right">
                By partnering with Ethicalcure Pharmaceuticals, you can:
              </h3>
              <div className="content_container">
                <ul
                  className="list-group"
            ...
            >
              <div className="abouts">
                <img className="img-fluid" src="https://img.freepik.com/free-photo/shopping-cart-with-pill-blister-medicines-glass-white-background_23-2147883704.jpg?size=626&ext=jpg&ga=GA1.1.1884802103.1674757283&semt=sph" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row g-5 align-items-center">
            ...
            >
              <div className="aboutsimg">
                <img className="img-fluid" src="https://img.freepik.com/free-vector/light-medicine-concept-with-realistic-medical-opened-capsule-pill-falling-out-small-balls-isolated_1284-49068.jpg?size=626&ext=jpg&ga=GA1.1.1884802103.1674757283&semt=sph" />
              </div>
            </div>
            ...
            <div className="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
              ...
              <div className="content_container">
                ...
                >
                  <li className="list-group-item" data-aos="fade-left">
                    <b> Global Impact: </b> Ethicalcure Pharmaceuticals strives to make a meaningful impact on a global scale by improving access to healthcare and advancing medical science.
                  </li>
                  <li className="list-group-item" data-aos="fade-left">
                  ...
                  <li className="list-group-item" data-aos="fade-left">
                    <b>Community Engagement: </b> Committed to giving back to the community, Ethicalcure Pharmaceuticals actively participates in philanthropic initiatives and supports healthcare initiatives in underserved regions.
                  </li>
      ...
      <div className="container-fluid section2 py-5">
        <div className="container">
          <div className="row g-5 align-items-center">
            ...
            >
              <div className="abouts">
                <img className="img-fluid" src="https://img.freepik.com/free-vector/realistic-vector-illustration-molecular-bio-technologies-laboratory-glassware-tubes-beaker_134830-1567.jpg?size=626&ext=jpg&ga=GA1.1.1884802103.1674757283&semt=sph" />
              </div>
            </div>
